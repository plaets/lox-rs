...
pub enum Stmt {
    ...
    Class { name: Box<Token>, methods: Vec<StmtVar::Fun>, superclass: Option<ExprVar::Variable>, mixins: Vec<ExprVar::Variable> },
...
pub enum Expr {
    ...
    Subscr { object: Box<Expr>, left_paren: Box<Token>, arg: Box<Expr> },
...
impl Expr {
    pub fn get_token(&self) -> Token {
        match self {
            ...
            Expr::Subscr(ExprVar::Subscr{left_paren, ..}) => *(left_paren.clone()),
